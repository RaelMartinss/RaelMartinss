...
## Olá, eu sou Rael Martins 👋

Sou Desenvolvedor Full Stack Jr, com foco em **Python, Django, React, TypeScript, JavaScript e SQL**.

Atualmente curso **Ciência da Computação** e desenvolvo projetos web envolvendo APIs, autenticação, banco de dados, interfaces modernas e automações.

### 🚀 Tecnologias que utilizo

<div align="left">
  <img src="https://skillicons.dev/icons?i=python,django,js,ts,react,nextjs,nodejs,html,css,tailwind,postgres,git,github,linux" />
</div>
...
* 🛠️ Interesse em automações, APIs, sistemas web e inteligência artificial
* 🌎 Buscando evoluir para oportunidades nacionais e internacionais
